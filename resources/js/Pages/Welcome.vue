        ...
        <div class="bg-indigo-700">
            <div class="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-extrabold text-white sm:text-4xl">
                    <span class="block">Start your freelance career.</span>
                    <span class="block">Start using {{$inertia.page.props.appName}} today.</span>
                </h2>
            ...
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                    ...
                    <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                        ...
                        <div class="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul class="mt-4 space-y-4">
                                    <li>
                                        <inertia-link :href="route('about')" class="text-base text-gray-500 hover:text-gray-900">
                                            About
                                        </inertia-link>
                                    </li>
                            ...
                            <div class="mt-12 md:mt-0">
                                ...
                                <ul class="mt-4 space-y-4">
                                    ...
                                    <li>
                                        <inertia-link :href="route('privacy')" class="text-base text-gray-500 hover:text-gray-900">
                                            Privacy
                                        </inertia-link>
                                    </li>

                                    <li>
                                        <inertia-link :href="route('tos')" class="text-base text-gray-500 hover:text-gray-900">
                                            Terms
                                        </inertia-link>
                                    </li>
                                </ul>
                ...
                <div class="mt-12 border-t border-gray-200 pt-8">
                    <p class="text-base text-gray-400 xl:text-center">
                        &copy; 2020 {{$inertia.page.props.appName}}, Inc. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
