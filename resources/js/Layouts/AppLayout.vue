<template>
    <div class="min-h-screen bg-gray-100">
        ...
        <div class="h-screen flex overflow-hidden bg-gray-100">
            ...
            <div class="md:hidden" v-if="showingNavigationDropdown">
                <div class="fixed inset-0 flex z-40 transition-opacity ease-linear duration-300">
                    ...
                    <div class="relative flex-1 flex flex-col max-w-xs w-full bg-gray-800">
                        <div class="absolute top-0 right-0 -mr-12 pt-2">
                            <button v-on:click="showingNavigationDropdown = false" class="ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                        ...
                        <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                            ...
                            <nav class="mt-5 px-2 space-y-1">
                                ...
                                <inertia-link href="/dashboard" class="bg-gray-900 text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
                        ...
                        <div class="flex-shrink-0 flex bg-gray-700 p-4">
                            <inertia-link href="/user/profile" class="flex-shrink-0 group block">
                                <div class="flex items-center">
                                    <div>
                                        <img class="inline-block h-10 w-10 rounded-full" :src="$page.user.profile_photo_url" alt="">
                                    </div>
                                    <div class="ml-3">
            ...
            <div class="flex flex-col w-0 flex-1 overflow-hidden">
                <div class="md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3">
                    <button v-on:click="showingNavigationDropdown = true" class="-ml-0.5 -mt-0.5 h-12 w-12 inline-flex items-center justify-center rounded-md text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
